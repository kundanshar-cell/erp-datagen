...
function runFullP2P(rows, options = {}) {
  ...
  const lfa1 = generateLFA1(vendorCount, { missingRate });
  ...
  const ekko = generateEKKO(poHeaderCount, { missingRate, vendorPool });
  ...
  const rbkp = generateRBKP(invoiceHeaderCount, { missingRate, vendorPool });
